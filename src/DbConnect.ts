...
import { DbOptionType, DbSecureType, DbType, DbConnectOptions, DbConnectType } from "./types";
...
export class DbConnect {
    ...
    constructor(dbConfig: DbOptionType, dbType: DbType = 'postgres', options: DbConnectOptions = {}) {
        ...
        this.dbType = dbConfig?.dbType || dbType || undefined;
...
export function newDbConnect(dbConfig: DbOptionType, dbType: DbType = 'postgres', options: DbConnectOptions = {}) {
