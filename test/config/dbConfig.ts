...
import { DbConfigsType } from "../../src/types";

export const dbs: DbConfigsType = {
    postgres: {
        ...
        password: process.env.PGDB_PWD || "ab12testing2",
    ...
    redis   : {
        ...
        password: process.env.REDISDB_PWD || "ab12testing",
    ...
    mysql   : {
        ...
        password: process.env.MYSQLDB_PWD || "ab12testing",
    ...
    mariadb : {
        ...
        password: process.env.MARIADB_PWD || "ab12testing",
    ...
    mssql   : {
        ...
        password: process.env.MSSQLDB_PWD || "ab12testing",
